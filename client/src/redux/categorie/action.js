...
export const sortByPrice = (range) => (dispatch, getState) => {
    ...
    if (min >= 1 && max <= 10) {
        ...
        const items = getState().categorie.categorie.filter(
...
// export const sortByPrice_10_100 = (range) => (dispatch, getState) => {
//     dispatch({
//         type: SORT_BY_PRICE_1_10,
//         payload: '',
//     });
...
// export const sortByPrice_100_1000 = (range) => (dispatch, getState) => {
//     dispatch({
//         type: SORT_BY_PRICE_1_10,
//         payload: '',
//     });
