            ...
            <div className="main__content-wrap">
                <div className="main__left">
                    ...
                    <div className="main__left-list">
                        <a href='/' className="main__left-item">Any</a>
                        <a href='/' className="main__left-item">Pants</a>
                        <a href='/' className="main__left-item">Shirts</a>
                    </div>
                    <h4 className="main__left-title">Price</h4>
                    <div className="main__left-list">
                        <a href='/' className="main__left-item">Any</a>
                        <a href='/' className="main__left-item">$1 to $10</a>
                        <a href='/' className="main__left-item">$10 to $100</a>
                        <a href='/' className="main__left-item">$100 to $1000</a>
                    </div>
                        ...
                        <a href="/" className="main__left-item">
                            <div>
                                <span>
                                    ...
                                    <i className="fa-solid fa-star"></i>
                                    <i className="fa-solid fa-star"></i>
                                    <i className="fa-solid fa-star-half-stroke"></i>& up
                                </span>
                            </div>
                        </a>
                    </div>
